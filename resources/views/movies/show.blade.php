        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            @else
                ...
                <div class="wishlist-content">
                   ...
                   <button
                        type="button" 
                        class="add-to-wishlist-btn flex inline-flex items-center bg-orange-500 text-gray-900 rounded font-semibold hover:bg-orange-600 transition ease-in-out duration-150"
                        style="width:150px; padding:13px;margin-top:10px">
